            ...
            <div className="space-y-2">
              ...
              {templates.map((t) => (
                ...
                >
                  ...
                  {t.approvalRequired && (
                    <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded-full bg-amber-100 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300">
                      Approval req.
                    </span>
                  )}
                </div>
        ...
        <section className="rounded-3xl border border-border/60 bg-card p-6 shadow-sm space-y-5">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 px-5 py-2.5 text-sm font-bold text-white transition-colors"
            >
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                {offer.status === "APPROVED" && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-xl bg-blue-600 hover:bg-blue-700 px-3 py-1.5 text-xs font-bold text-white transition-colors"
                  >
