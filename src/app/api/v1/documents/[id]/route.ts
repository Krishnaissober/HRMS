...
import { documentStateSchema } from "@/modules/documents-notifications/schemas";
import { setDocumentState } from "@/modules/documents-notifications/service";
  ...
  try {
    ...
    return successResponse(
      await setDocumentState({
        ...
        id: (await params).id,
        ...parseBody(documentStateSchema, await r.json()),
        requestId: q,
      }),
      q,
    );
